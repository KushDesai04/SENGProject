...
/**
 * This is the ShopScreen class. This screen will allow players to purchase
 * athletes and items. There are 3 athletes and 3 items that are randomly
...
public class ShopScreen {
	...
	/**
	 * Calls closeShopScreen within the GameManager object which opens the next
	 * window.
	 */
	...
	/**
	 * Displays the information of the selected Athlete in the shop when its
	 ...
	 */
	public void athleteButtonEvent(JButton btn, JLabel name, JLabel ovr, JLabel off, JLabel def, JLabel stam,
			JLabel agil, int index) {
		name.setText(manager.getMarket().getPurchasableAthletes().get(index).toString()); // Set name label to athlete
																							// name
		ovr.setText("$" + String.valueOf(manager.getMarket().getPurchasableAthletes().get(index).getPrice()));
		off.setText("Offence: "
				+ String.valueOf(manager.getMarket().getPurchasableAthletes().get(index).getStat(Athlete.STATS.O)));
		def.setText("Defence: "
				+ String.valueOf(manager.getMarket().getPurchasableAthletes().get(index).getStat(Athlete.STATS.D)));
		stam.setText("Stamina: "
				+ String.valueOf(manager.getMarket().getPurchasableAthletes().get(index).getStat(Athlete.STATS.S)));
		agil.setText("Agility: "
				+ String.valueOf(manager.getMarket().getPurchasableAthletes().get(index).getStat(Athlete.STATS.A)));
	...
	/**
	 * Displays the information of the selected Item in the shop when its
	 * corresponding JButton is pressed.
	 * 
	 * @param btn   the selected JButton
	 ...
	 * @param off   the label displaying the offence stat of the Athlete, which will
	 *              be set to show the description of the Item
	 * @param def   the label displaying the defence stat of the Athlete, which will
	 *              be set to blank
	 * @param stam  the label displaying the stamina stat of the Athlete, which will
	 *              be set to blank
	 * @param agil  the label displaying the agility stat of the Athlete, which will
	 *              be set to blank
	 * @param index the index of the Item in the list of purchasable Item
	 */
	public void itemButtonEvent(JButton btn, JLabel name, JLabel ovr, JLabel off, JLabel def, JLabel stam, JLabel agil,
			int index) {
	 ...
	 * 
	 * @param btns list of buttons that will be set to show the information of
	 *             Items.
	 */
	...
	private void initialize() {
					...
					if (consumable instanceof Athlete) {
						if (manager.getMoney() < ((Athlete) consumable).getPrice()) {
							...
							if (choice == 0) {
								...
								manager.getTeam().replacePlayer((Athlete) consumable,
										manager.getTeam().getPlayersMap().get(((Athlete) consumable).getPosition()));
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE).addGap(52)
						.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addGroup(groupLayout.createSequentialGroup()
										.addComponent(btnBuy, GroupLayout.PREFERRED_SIZE, 291,
												GroupLayout.PREFERRED_SIZE)
										.addGap(23))
								.addGroup(groupLayout.createSequentialGroup().addComponent(panel,
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_1.createSequentialGroup()
						.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_1.createSequentialGroup().addContainerGap().addComponent(separator_1,
										GroupLayout.DEFAULT_SIZE, 703, Short.MAX_VALUE))
								.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
										.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_panel_1.createSequentialGroup()
														.addComponent(btnItem1, GroupLayout.DEFAULT_SIZE, 231,
																Short.MAX_VALUE)
														.addGap(6))
												.addGroup(gl_panel_1.createSequentialGroup()
														.addComponent(btnPlayer1, GroupLayout.DEFAULT_SIZE, 234,
																Short.MAX_VALUE)
														.addGap(3)))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
												.addComponent(btnPlayer2, GroupLayout.DEFAULT_SIZE, 230,
														Short.MAX_VALUE)
												.addComponent(btnItem2, GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
												.addComponent(btnPlayer3, GroupLayout.DEFAULT_SIZE, 230,
														Short.MAX_VALUE)
												.addComponent(btnItem3, GroupLayout.DEFAULT_SIZE, 230,
														Short.MAX_VALUE)))
								.addGroup(gl_panel_1.createSequentialGroup().addGap(9)
										...
										.addGap(73).addComponent(lblMoney, GroupLayout.PREFERRED_SIZE, 192,
												GroupLayout.PREFERRED_SIZE))
								...
								.addGroup(gl_panel_1.createSequentialGroup().addContainerGap().addComponent(lblItems,
										GroupLayout.PREFERRED_SIZE, 114, GroupLayout.PREFERRED_SIZE)))
						.addContainerGap()));
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
						.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
										.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
												.addComponent(lblMoney, GroupLayout.PREFERRED_SIZE, 28,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(lblShop))))
						.addGap(8).addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGap(26).addComponent(separator_1, GroupLayout.PREFERRED_SIZE, 5, GroupLayout.PREFERRED_SIZE)
						.addGap(18).addComponent(lblItems, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
