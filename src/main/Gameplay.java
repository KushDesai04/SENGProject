...
/**
 * The Gameplay class represents a game session between a player's team and an
 * opposing team. It manages the gameplay logic, including calculating points
...
public class Gameplay {
	...
	/**
	 * Constructs a new Gameplay object with the specified player's Team, opposing
	 * Team, and difficulty.
	 *
	...
	/**
	 * Simulates the gameplay, calculating points for each player and updating their
	 * stamina accordingly.
	 */
	public void play() {
	...
	/**
	 * Determines the winner of the game based on the total points earned by the
	 * player's Team and the opposing Team.
	 *
	 * @return The result of the game: "player" if the player's team has more
	 *         points, "draw" if the points are equal, or "opponent" if the opposing
