...
/**
 * This is the Team class. This class handles the logic to provide a functioning
 * team for the game. The team consists of players, reserves, and consumable
 * items. It allows adding, selling, and replacing Athletes, as well as buying
 * and selling consumable Items. The Team's ability to play is determined by the
 * number of players and their injury status. The Team can also restore the
 * stamina of its players. Each Team has a unique name.
 * 
 * @author Yunu Cho
 * @author Kush Desai
 * 
...
public class Team {
	...
	/**
	 * Adds an Athlete to the Team's player mapping, used to add players into the
	 * opponent Team.
	 *
	...
	/**
	 * Replaces an Athlete in the Team's player mapping with another Athlete. The
	 * replaced Athlete is added to the reserves.
	 *
	 ...
	 * players and none of them are injured.
	 *
	...
	/**
	 * Restores the stamina of all Athletes in the Team. This method sets the
	 * current stamina of each Athlete to their maximum stamina.
	 */
