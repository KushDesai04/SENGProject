...
/**
 * This is the TeamScreen class. The team screen will allow players to access
 * their Team and make changes such as: Selecting the starting lineup, selling
 * players, and using consumables to increase player stats.
 * 
 * @author Yunu Cho
 * @author Kush Desai
 * 
...
public class TeamScreen {
	...
	/**
	 * Calls closeTeamScreen within the GameManager object which opens the next
	 * window.
	 */
	...
	/**
	 * Displays the information of the selected Athlete in the starting lineup when
	 * its corresponding JButton is pressed.
	 * 
	...
	public void starterButtonEvent(JButton btn, Athlete.POSITION pos, JLabel name, JLabel price, JLabel off, JLabel def,
			JLabel stam, JLabel agil, JList<Item> itemList, JList<Athlete> reserveList, JLabel currStam) {
	 ...
	 * corresponding JButton is pressed or its corresponding JList entry is
	 * selected.
	 * 
	...
	/**
	 * Refreshes the labels to display the information of the given Item when its
	 ...
	 * @param off      the label displaying the offence stat of the Athlete, which
	 *                 will be set to display the description of the Item
	 * @param def      the label displaying the defence stat of the Athlete, which
	 *                 will be set to blank
	 * @param stam     the label displaying the stamina stat of the Athlete, which
	 *                 will be set to blank
	 * @param agil     the label displaying the agility stat of the Athlete, which
	 *                 will be set to blank
	 * @param currStam the label displaying the current stamina of the Athlete,
	 *                 which will be set to blank
	 */
	public void refreshItemLabels(Item item, JLabel name, JLabel price, JLabel off, JLabel def, JLabel stam,
			JLabel agil, JLabel currStam) {
	...
	/**
	 * Sets starter buttons to display the information of the current starting
	 * Athletes.
	 * 
	...
	private void initialize() {
		...
		tglBtnPG_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					manager.getTeam().replacePlayer(athlete,
							manager.getTeam().getPlayersMap().get(athlete.getPosition()));
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel.createSequentialGroup().addGap(10).addGroup(gl_panel
						...
						.addGroup(gl_panel.createSequentialGroup()
								.addComponent(nameLabel, GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE).addGap(16))
						.addGroup(gl_panel.createSequentialGroup()
		...
		btnSetName.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (lastSelectedAthlete instanceof Athlete) {
					if (name.length() < 3 | !name.matches("([a-zA-Z]+[ ]*)+" )| name.length() > 10) {
						String message = "The name must be 3-10 characters long and not contain any special characters!";
						JOptionPane.showMessageDialog(new JFrame(), message, "Name Change Error",
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
								...
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addComponent(tglBtnPG_5, GroupLayout.PREFERRED_SIZE, 33,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnSellAthlete, GroupLayout.PREFERRED_SIZE, 33,
												GroupLayout.PREFERRED_SIZE))
		...
		btnPG.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				starterButtonEvent(btnPG, Athlete.POSITION.PG, nameLabel, priceLabel, offValue, defValue, stamValue,
		...
		btnSG.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				starterButtonEvent(btnSG, Athlete.POSITION.SG, nameLabel, priceLabel, offValue, defValue, stamValue,
						agilValue, itemList, reservesList, currStamValue);
			}
		});
		...
		btnC.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				starterButtonEvent(btnC, Athlete.POSITION.C, nameLabel, priceLabel, offValue, defValue, stamValue,
						agilValue, itemList, reservesList, currStamValue);
			}
		});
		...
		btnSF.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				starterButtonEvent(btnSF, Athlete.POSITION.SF, nameLabel, priceLabel, offValue, defValue, stamValue,
						agilValue, itemList, reservesList, currStamValue);
			}
		});
		...
		btnPF.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				starterButtonEvent(btnPF, Athlete.POSITION.PF, nameLabel, priceLabel, offValue, defValue, stamValue,
						agilValue, itemList, reservesList, currStamValue);
			}
		});
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_1.createSequentialGroup().addGap(11)
						.addComponent(lblStarters, GroupLayout.DEFAULT_SIZE, 366, Short.MAX_VALUE).addGap(11))
				.addGroup(gl_panel_1.createSequentialGroup().addGap(6).addGroup(gl_panel_1
						.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup()
								.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
										.addComponent(lblPointGuard, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 90,
												Short.MAX_VALUE)
										.addComponent(btnPG, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 90,
												Short.MAX_VALUE))
								.addGap(54)
								.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_panel_1.createSequentialGroup().addGap(82)
								.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
										.addComponent(lblSmallForward, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 94,
												Short.MAX_VALUE)
										.addComponent(btnSF, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 94,
												Short.MAX_VALUE))
								.addGap(50)
								.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
		...
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
						...
						.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_1.createSequentialGroup()
										.addComponent(lblSmallForward, GroupLayout.PREFERRED_SIZE, 25,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(btnSF, GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE))
								.addGroup(gl_panel_1.createSequentialGroup()
										.addComponent(lblPowerForward, GroupLayout.PREFERRED_SIZE, 25,
												GroupLayout.PREFERRED_SIZE)
